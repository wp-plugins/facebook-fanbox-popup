...
class ilenframework_component_list_category{
	...
	function IF_getCategories( $args = array() ){

		global $IF;
		
		$array_categories['-1'] = __('All',$IF->parameter['name_option']) ;
	...
	function display( $id_name , $seleted_array = array() ){			
		...
		$list_categories = $this->IF_getCategories();
