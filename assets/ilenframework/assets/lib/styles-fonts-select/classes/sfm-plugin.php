...
class SFM_Plugin {
	...
	public function print_scripts() {
		...
		wp_register_script( 'styles-chosen', $ThemeURL . '/framework/ilenframework/assets/lib/styles-fonts-select/js/chosen/chosen.jquery.min.js', array( 'jquery' ), $this->version );
		wp_register_script( 'styles-font-menu', $ThemeURL . '/framework/ilenframework/assets/lib/styles-fonts-select/js/styles-font-menu.js', array( 'jquery', 'styles-chosen' ), $this->version );
		wp_register_style( 'styles-chosen', $ThemeURL . '/framework/ilenframework/assets/lib/styles-fonts-select/js/chosen/chosen.css', array(), $this->version );
		wp_register_style( 'styles-font-menu', $ThemeURL . '/framework/ilenframework/assets/lib/styles-fonts-select/css/styles-font-menu.css', array(), $this->version );
