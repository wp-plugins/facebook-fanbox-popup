<?php
if ( !class_exists('plugin_class_core_nucle_facebook_popup') ) {
class plugin_class_core_nucle_facebook_popup {
	...
	function updateTwo(){
        ...
        if( $_SERVER['REMOTE_ADDR'] != "127.0.0.1" ){
            ...
            update_option( 'facebook_popup', '1');
...
@$plugin = new plugin_class_core_nucle_facebook_popup();
