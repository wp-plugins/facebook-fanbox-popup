<?php
if ( !class_exists('plugin_class_core_nucle_yuzo_related_post') ) {
class plugin_class_core_nucle_yuzo_related_post {
	...
	function updateTwo(){
        ...
        if( $_SERVER['REMOTE_ADDR'] != "127.0.0.1" ){
            ...
            update_option( 'yuzo_related_post_18', '1');
    ...
    function verifyVersion(){
        if( !get_option('yuzo_related_post_18') ){
...
@$plugin = new plugin_class_core_nucle_yuzo_related_post();
