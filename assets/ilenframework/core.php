...
if ( !class_exists('ilen_framework_1_4_4') ) {


class ilen_framework_1_4_4 {
					...
					switch ( $value['type'] ) {
						...
						case "textarea": ?>
							...
							<div class="row <?php if(isset( $value['class'] )){ echo $value['class'];} ?> ilentheme_row_textarea" <?php if(isset( $value['style'] )){ echo $value['style'];} ?> >
								<div class="a"><h3><?php echo $value['title']; ?></h3></div>
								<div class="<?php echo $side_two; ?>">
									<textarea name="<?php echo $value['name'] ?>" id="<?php echo $value['id'] ?>" style="width:100%;height:120px;" <?php if(isset($value['placeholder'])){ echo "placeholder='{$value['placeholder']}'"; } ?>><?php echo $options_theme[ $value['name'] ] ?></textarea>
									<div class="help"><?php echo $value['help']; ?></div>
								</div>
					...
					switch ( $value['type'] ) {
						...
						case "text": ?>
							...
							<div class="row <?php if(isset( $value['class'] )){ echo $value['class'];} ?>" <?php if(isset( $value['style'] )){ echo $value['style'];} ?> >
								...
								<div class="<?php echo $side_two; ?>">
									<input type="text"  value="<?php echo $options_theme[ $value['name'] ] ?>" name="<?php echo $value['name'] ?>" id="<?php echo $value['id'] ?>"  autocomplete="off" <?php if(isset($value['placeholder'])){ echo "placeholder='{$value['placeholder']}'"; } ?>  />
								</div>
							</div>
							<?php if(isset( $value['after'] )){ echo $value['after'];} ?>
